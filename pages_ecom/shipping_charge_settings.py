...
class ShippingChargeSettings:
    ...
    def add_shipping_settings(self, logistic_charge,city_name):
        ...
        time.sleep(0.5)
        self.shipping_info(logistic_charge, city_name)
        time.sleep(0.5)


        
    @allure.step("Editing shipping charge settings")
    def edit_shipping_charge_settings(self, logistic_charge,city_name):
    ...
    def shipping_info(self, logistic_charge,city_name):
        # Basic Info
        ...
        update_btn = self.wait.until(EC.presence_of_element_located(ShippingChargeLocators.UPDATE_BTN))
        try:
            update_btn.click()
    ...
    def delete_shipping_settings(self):
        ...
        try:
            ...
            confirm_btn = self.wait.until(EC.presence_of_element_located(ShippingChargeLocators.CONFIRM_DELETE_BTN))
            try:
                confirm_btn.click()
